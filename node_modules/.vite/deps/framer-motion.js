...
function useFeatures(props, visualElement2, preloadedFeatures) {
  const features = [];
  const lazyContext = (0, import_react2.useContext)(LazyContext);
  if (!visualElement2)
    return null;
  ...
  for (let i = 0; i < numFeatures; i++) {
    ...
    if (isEnabled(props) && Component2) {
      features.push(React.createElement(Component2, Object.assign({ key: name }, props, { visualElement: visualElement2 })));
    }
  }
  return features;
}
...
function useReducedMotion() {
  ...
  const [shouldReduceMotion] = (0, import_react7.useState)(prefersReducedMotion.current);
  return shouldReduceMotion;
}
function useReducedMotionConfig() {
  const reducedMotionPreference = useReducedMotion();
  const { reducedMotion } = (0, import_react7.useContext)(MotionConfigContext);
...
function useMotionRef(visualState, visualElement2, externalRef) {
  return (0, import_react9.useCallback)((instance) => {
    var _a;
...
function useProjection(projectionId, { layoutId, layout, drag: drag2, dragConstraints, layoutScroll }, visualElement2, ProjectionNodeConstructor) {
  var _a;
  const initialPromotionConfig = (0, import_react14.useContext)(SwitchLayoutGroupContext);
...
var VisualElementHandler = class extends import_react15.default.Component {
...
function createMotionComponent({ preloadedFeatures, createVisualElement, projectionNodeConstructor, useRender, useVisualState: useVisualState2, Component: Component2 }) {
  ...
  function MotionComponent(props, externalRef) {
    ...
    const config = (0, import_react16.useContext)(MotionConfigContext);
    let features = null;
    ...
    return React2.createElement(VisualElementHandler, { visualElement: context.visualElement, props: Object.assign(Object.assign({}, config), props) }, features, React2.createElement(MotionContext.Provider, { value: context }, useRender(Component2, props, projectionId, useMotionRef(visualState, context.visualElement, externalRef), visualState, config.isStatic, context.visualElement)));
  }
  return (0, import_react16.forwardRef)(MotionComponent);
}
function useLayoutId({ layoutId }) {
  var _a;
  const layoutGroupId = (_a = (0, import_react16.useContext)(LayoutGroupContext)) === null || _a === void 0 ? void 0 : _a.id;
...
function useUnmountEffect(callback) {
  return (0, import_react22.useEffect)(() => () => callback(), []);
}
...
var animations = {
  animation: makeRenderlessComponent(({ visualElement: visualElement2, animate: animate4 }) => {
    ...
    if (isAnimationControls(animate4)) {
      (0, import_react26.useEffect)(() => animate4.subscribe(visualElement2), [animate4]);
    }
  }),
...
function useDrag(props) {
  ...
  (0, import_react27.useEffect)(() => groupDragControls && groupDragControls.subscribe(dragControls), [dragControls, groupDragControls]);
  (0, import_react27.useEffect)(() => dragControls.addListeners(), [dragControls]);
}
...
function usePanGesture({ onPan, onPanStart, onPanEnd, onPanSessionStart, visualElement: visualElement2 }) {
  ...
  const panSession = (0, import_react28.useRef)(null);
  const { transformPagePoint } = (0, import_react28.useContext)(MotionConfigContext);
  const handlers = {
...
// node_modules/framer-motion/dist/es/motion/features/layout/MeasureLayout.mjs
var MeasureLayoutWithContext = class extends import_react29.default.Component {
  componentDidMount() {
...
function MeasureLayout(props) {
  ...
  return import_react29.default.createElement(MeasureLayoutWithContext, Object.assign({}, props, { layoutGroup, switchLayoutGroup: (0, import_react29.useContext)(SwitchLayoutGroupContext), isPresent: isPresent2, safeToRemove }));
}
...
function useForceUpdate() {
  ...
  const [forcedRenderCount, setForcedRenderCount] = (0, import_react31.useState)(0);
  const forceRender = (0, import_react31.useCallback)(() => {
    isMounted.current && setForcedRenderCount(forcedRenderCount + 1);
  }, [forcedRenderCount]);
  const deferredForceRender = (0, import_react31.useCallback)(() => es_default.postRender(forceRender), [forceRender]);
...
function PopChild({ children, isPresent: isPresent2 }) {
  ...
  const size = (0, import_react32.useRef)({
    width: 0,
    height: 0,
    top: 0,
    left: 0
...
var AnimatePresence = ({ children, custom, initial = true, onExitComplete, exitBeforeEnter, presenceAffectsLayout = true, mode = "sync" }) => {
  ...
  const forceRenderLayoutGroup = (0, import_react34.useContext)(LayoutGroupContext).forceRender;
  ...
  return React5.createElement(React5.Fragment, null, exiting.size ? childrenToRender : childrenToRender.map((child) => (0, import_react34.cloneElement)(child)));
};
...
var LayoutGroup = ({ children, id: id3, inheritId, inherit = true }) => {
  ...
  const memoizedContext = (0, import_react36.useMemo)(() => Object.assign(Object.assign({}, context.current), { forceRender }), [key]);
...
var AnimateSharedLayout = ({ children }) => {
  ...
  return React7.createElement(LayoutGroup, { id: useConstant(() => `asl-${id2++}`) }, children);
};
...
function MotionConfig(_a) {
  ...
  config = Object.assign(Object.assign({}, (0, import_react37.useContext)(MotionConfigContext)), config);
  config.isStatic = useConstant(() => config.isStatic);
  const context = (0, import_react37.useMemo)(() => config, [JSON.stringify(config.transition), config.transformPagePoint, config.reducedMotion]);
  return React8.createElement(MotionConfigContext.Provider, { value: context }, children);
}
...
function LazyMotion({ children, features, strict = false }) {
  const [, setIsLoaded] = (0, import_react38.useState)(!isLazyBundle(features));
  const loadedRenderer = (0, import_react38.useRef)(void 0);
  ...
  return React9.createElement(LazyContext.Provider, { value: { renderer: loadedRenderer.current, strict } }, children);
}
...
var ReorderContext = (0, import_react39.createContext)(null);
...
function ReorderGroup(_a, externalRef) {
  ...
  const order3 = [];
  const isReordering = (0, import_react40.useRef)(false);
  ...
  return React10.createElement(Component2, Object.assign({}, props, { ref: externalRef }), React10.createElement(ReorderContext.Provider, { value: context }, children));
}
var Group = (0, import_react40.forwardRef)(ReorderGroup);
...
function useMotionValue(initial) {
  ...
  if (isStatic) {
    const [, setLatest] = (0, import_react41.useState)(initial);
    (0, import_react41.useEffect)(() => value.onChange(setLatest), []);
  }
  return value;
}
...
function ReorderItem(_a, externalRef) {
  ...
  const Component2 = useConstant(() => motion(as));
  const context = (0, import_react42.useContext)(ReorderContext);
  const point2 = {
  ...
  const measuredLayout = (0, import_react42.useRef)(null);
  invariant(Boolean(context), "Reorder.Item must be a child of Reorder.Group");
  const { axis, registerItem, updateOrder } = context;
  (0, import_react42.useEffect)(() => {
    registerItem(value, measuredLayout.current);
  }, [context]);
  return React11.createElement(Component2, Object.assign({ drag: axis }, props, { dragSnapToOrigin: true, style: Object.assign(Object.assign({}, style2), { x: point2.x, y: point2.y, zIndex }), layout, onDrag: (event, gesturePoint) => {
...
var Item = (0, import_react42.forwardRef)(ReorderItem);
...
function useSpring(source, config = {}) {
  ...
  const activeSpringAnimation = (0, import_react43.useRef)(null);
...
function useAnimationFrame(callback) {
  const initialTimestamp = (0, import_react45.useRef)(0);
  const { isStatic } = (0, import_react45.useContext)(MotionConfigContext);
...
function useCycle(...items) {
  ...
  const runCycle = (0, import_react47.useCallback)((next) => {
